...
def render_detective_quiz():
    ...
    html_content = html_content.replace(
        '__INTRO_TITLE_EN__', intro_finale.get('title_subtitle_en', DEFAULT_INTRO_FINALE['title_subtitle_en'])
    )
    html_content = html_content.replace(
        '__MISSION_CN__', intro_finale.get('mission_cn', DEFAULT_INTRO_FINALE['mission_cn'])
    )
    html_content = html_content.replace(
        '__MISSION_EN__', intro_finale.get('mission_en', DEFAULT_INTRO_FINALE['mission_en'])
    )
    html_content = html_content.replace(
        '__FINALE_SUMMARY_CN__', intro_finale.get('finale_summary_cn', DEFAULT_INTRO_FINALE['finale_summary_cn'])
    )
    html_content = html_content.replace(
        '__FINALE_SUMMARY_EN__', intro_finale.get('finale_summary_en', DEFAULT_INTRO_FINALE['finale_summary_en'])
    )
