...
# 标签页
tab1, tab2, tab3 = st.tabs(["📈 学生总表", "📊 班级错词统计", "📋 详细答题记录"])
        ...
        if not teacher_classes:
            ...
            query = f"""
                SELECT a.class_name, a.student_id, a.student_name, a.word,
                       a.step_type, a.is_correct, a.chosen_idx, a.correct_idx, a.answered_at,
            ...
            if not rows:
                ...
                df_display.columns = ["班级", "学号", "姓名", "课文", "词语", "关卡", "对错", "选了", "正解", "时间"]
                st.dataframe(df_display, use_container_width=True, hide_index=True)
